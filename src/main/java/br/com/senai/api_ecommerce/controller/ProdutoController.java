...
public class ProdutoController {
    ...
    @GetMapping("/{id}")
    @Operation(summary = "Listar produto detalhadamente")
    ...
    @ApiResponses( value = {
            ...
            @ApiResponse(responseCode = "409", description = "SKU já cadastrado", content = @Content),
            @ApiResponse(responseCode = "400", description = "Categoria não encontrada / Produto não encontrado", content = @Content)
    })
